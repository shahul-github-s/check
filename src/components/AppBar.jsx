...
const AppBar = ({ title }) => {
  ...
  return (
    <>
      ...
      <AppBarWrapper>
        <div
          className="flex gap-8 items-center justify-end relative py-4 md:gap-0 xl:py-6 xl:px-8 xl:mb-2
                     4xl:p-0 4xl:mb-[18px]"
        >
          ...
          <div className="flex gap-8">
            <div className="flex items-center">
              ...
              >
                <input
                  className="bg-transparent h-8 !rounded-[0px] border-b border-sidebar dark:border-border -mt-2
            ...
            {/* <Tooltip
              ...
              classes={{
                tooltip:
                  "!bg-transparent !p-0 !pt-[28px] !m-0 !w-[288px] xs:!min-w-[360px] !font-sans will-change-transform",
                popper: "px-4 md:px-0 !w-[288px] xs:!w-[360px]",
              }}
              enterTouchDelay={0}
            ...
            >
              <button className="btn-icon w-[29px]" aria-label="Notifications">
            ...
            >
              <i
                className={`icon-${
                  theme === "light" ? "sun-bright" : "moon-stars"
                }-regular`}
              />
            </button>
            <Tooltip
              ...
              TransitionProps={{ timeout: 400 }}
            >
              {/* <button className="btn-icon w-[29px]" aria-label="Shopping cart">
                <i className="icon-cart-shopping-regular" />
                <span className="badge bg-turquoise">3</span>
              </button> */}
            </Tooltip>
          </div>
