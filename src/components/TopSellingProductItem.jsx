...
const TopSellingProductItem = ({
  ...
  return (
    <div className="flex items-center gap-4">
      <div
        className="rounded-lg overflow-hidden aspect-square shrink-0"
        style={{ width: imgSize }}
      >
        <img
          width={imgSize}
      ...
      <div className="flex flex-col items-start">
        ...
        {withCategory ? (
          <span
            className={`capitalize text-xs text-label dark:text-[var(--border-light)] mt-0.5 ${
              subtitleClass || ""
            }`}
          >
          ...
          <span
            className={`font-medium uppercase text-xs text-label mt-1 ${
              subtitleClass || ""
            }`}
          >
