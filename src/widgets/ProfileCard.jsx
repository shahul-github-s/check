      ...
      <div className="flex flex-col flex-1 justify-between gap-4">
        <div className="flex flex-col items-center gap-4 xs:flex-row xs:gap-6">
          <div className="relative">
            ...
            {isPrivate && (
              <button
                className="w-6 h-6 rounded-full bg-peach absolute bottom-0 -right-1 flex items-center justify-center"
          ...
          <div className="flex flex-col items-center gap-2 xs:items-start">
            <h3>{fullName}</h3>
            <span className="text-header font-semibold uppercase">
              {data.role}
            </span>
          </div>
        </div>
        <ul>
          ...
          <li className="flex justify-between items-center font-medium pt-4 pb-[14px] border-b">
            ...
            {isPrivate ? (
              ...
              <a
                className="max-w-[160px] truncate xxs:max-w-[200px]"
          ...
          <li
            className={`flex justify-between items-center font-medium pt-4 ${
              !isPrivate ? "pb-[14px] border-b" : ""
            }`}
          >
