  ...
  return (
    <Spring className="card relative h-[392px] p-6 overflow-hidden md:h-full">
      ...
      {/*   <div className="relative z-10 h-full flex flex-col items-start">
        <h2 className="mb-[18px] text-header-light">Whatsapp Campion Post</h2>
         <div
          className="flex items-center justify-center h-9 backdrop-blur-md rounded-xl px-5"
        ...
        <div className="flex flex-col items-start gap-2.5 mt-auto">
          <NavLink
            className="text-header-light font-bold text-[16px] md:text-[18px]"
            to="/product"
          >
            Single Breasted Blazer
          </NavLink>
          <span className="h3 !text-header-light">$1499.99</span>
        </div> 
      </div>*/}
    </Spring>
  );
